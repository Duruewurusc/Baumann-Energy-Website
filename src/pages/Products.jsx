                    ...
                    {currentProducts.map((product) => (
                      ...
                      >
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                          ...
                          <button className="mt-auto w-full bg-transparent text-[#16a34a] py-3.5 rounded-xl text-sm font-medium transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2 group/btn border border-[#16a34a]/20 hover:bg-[#16a34a] hover:text-white">
                            View Details
